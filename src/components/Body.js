...
function Body() {
    return (
        <div style={{display: "flex", flexWrap: "wrap", flexDirection: "column"}}>
            ...
            <div style={{width: "100%", display: "inline-flex", flexDirection: "row", flexWrap: "wrap"}}>
            ...
            <div style={{width: "100%", display: "inline-flex", flexDirection: "row", margin: "5px 0px"}}>
                <div style={{ boxShadow: "2.5px 5px", height: "460px", width: "100%", border: "1px solid black", margin: "2.5px"}}>SOMETHING HERE</div>
            </div>
            
            <div style={{width: "100%", display: "inline-flex", flexDirection: "row"}}>
